...
import { RecognizableFace, FaceRecognition } from "./faceRecognition.js"
...
export class IdCapture {
    ...
    async detectIdCard(images: { front?: string, back?: string }): Promise<Array<{ face?: RecognizableFace }>> {
     ...
     * @alpha
     */
    captureIdCard(settings: IDCaptureSettings): Observable {

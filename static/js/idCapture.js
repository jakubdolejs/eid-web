...
import { createRecognizableFace } from "./faceRecognition.js";
export function detectIdCard(images) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (imageSide) {
            json.face = yield createRecognizableFace(imageSide.fullDocumentImageBase64);
        }
        return json;
    });
}
...
export function captureIdCard(settings) {
